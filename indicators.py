# indicators.py - Verified Institutional Math (Fixed & Complete)
import pandas as pd
import numpy as np
...
def calc_ma_trend(df):
    ...
    try:
        ...
        # Exponential Moving Averages (for Shannon stack)
...
def calc_adx(df, period=14):
    try:
        # Standard ADX Logic with Index Alignment
        up = df['High'].diff()
        down = -df['Low'].diff()
        
        # Create Series to preserve index
        ...
        tr = tr.replace(0, 0.0001) # Zero division protection
